...
public class ej02 {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				op = keyboard.next();
				// 2. Controlar que el usuario introduzca solamente +, -, * o /, si no se
				// pedirán los datos de nuevo
				if (!op.equals(SUM) && !op.equals(RES) && !op.equals(MULT) && !op.equals(DIV)) {
					...
					// 5. Llamamos a la función
					System.out.println("(enteros)" + num1 + " " + op + " " + num2 + " = " + operation((int)num1, (int)num2, op));
					System.out.println("(decimales)" + num1 + " " + op + " " + num2 + " = "
	...
	// 4. Creamos una función para realizar la operación deseada cuyos parámetros
	// son los datos introducidos por teclado
	...
	// 6. Crea una nueva función sobrecargando la del ejercicio 2 para que se pueda
